  ...
  return (
    ...
    >
      <div className="relative flex items-start gap-4 sm:flex-col sm:items-center">
        <div className="font-display flex size-14 shrink-0 items-center justify-center rounded-2xl border border-copper/20 bg-ember-soft text-lg font-extrabold text-copper shadow-[0_10px_24px_-18px_rgba(166,93,58,0.55)] transition-transform duration-500 group-hover:scale-105 group-hover:border-copper/40 group-hover:shadow-[0_14px_28px_-16px_rgba(166,93,58,0.65)] sm:size-16 sm:text-xl">
          {number}
        </div>
        {!isLast ? (
          <span
      ...
      <div className="card-lift rounded-2xl border border-line bg-surface p-5 hover:border-copper/20 hover:shadow-[0_16px_36px_-28px_rgba(28,25,23,0.35)] sm:p-6">
