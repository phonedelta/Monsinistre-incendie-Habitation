  ...
  return (
    <section id="situation" className="section-pad section-anchor bg-ivory">
      <div className="page-container">
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-[1.75rem] border border-line bg-surface p-5 shadow-[0_18px_50px_-36px_rgba(31,51,52,0.35)] sm:mt-12 sm:p-8">
          <ul className="space-y-3.5">
            {eligibilityItems.map((item, index) => (
              <AnimatedSection
                ...
                as="li"
                delay={index * 80}
                className="flex items-start gap-3 rounded-2xl border border-line/80 bg-beige/40 px-4 py-3.5 transition-all duration-300 hover:border-primary-hover hover:bg-beige hover:translate-x-0.5"
              >
